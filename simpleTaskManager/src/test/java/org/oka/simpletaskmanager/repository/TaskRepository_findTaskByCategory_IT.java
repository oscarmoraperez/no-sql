...
public class TaskRepository_findTaskByCategory_IT {
    @Autowired
    TaskRepository taskRepository;

    @Test
    public void shouldReturnTaskPerCategory() {
        // Given
        ...
        // When
        Collection<Task> tasksByCategory = taskRepository.findTaskByCategory("DIY");

        // Then
        List<Task> tasks = new ArrayList<>(tasksByCategory);
